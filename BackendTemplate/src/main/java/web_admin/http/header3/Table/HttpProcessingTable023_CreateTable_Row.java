...
@Http(api = API.DBTable_Create_Row)
@HttpDocument(id = 3023, Header = API.H3_Database, Description = DES.Table_Create)
public class HttpProcessingTable023_CreateTable_Row extends BaseCreateTable {
	public DTO_Column[] Describes;
	
	private transient DBTableRow database;
	@Override public byte onTableType() {return BGBaseDatabase.DBTYPE_Row;}
	@Override public BGBaseDatabase onCreateTable(String path) throws IOException {
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		database=new DBTableRow(path);
		database.initNewDatabase(list);
		return database;
	}
