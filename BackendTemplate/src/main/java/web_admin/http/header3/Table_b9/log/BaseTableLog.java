...
public abstract class BaseTableLog extends BaseHttpAdminWeb_SignedIn {
	public short DBId;
	public short TableId;
	
	public abstract MyRespone onProcess(DBLog database,BackendSession session) throws IOException;
